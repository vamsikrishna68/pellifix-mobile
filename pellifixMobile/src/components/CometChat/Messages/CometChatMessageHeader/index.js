...
class CometChatMessageHeader extends React.Component {
  ...
  render() {
    ...
    let userName;
    let presence;
    if (this.props.type === CometChat.RECEIVER_TYPE.USER && this.props.item) {
      ...
      userName = this.props.item && this.props.item.name;
    }
    ...
    if (
      this.props.item && this.props.item.blockedByMe === true ||
        ...
        <View style={styles.headerDetailContainer}>
          <View
            ...
            <CometChatAvatar
              image={{ uri: image }}
              cornerRadius={25}
              borderColor={this.props.theme.borderColor.red}
              borderWidth={0}
              name={userName}
            />
            {presence}
